...
### GraphQL overview <a href="#graphql-overview" id="graphql-overview"></a>
...
![](https://0xn3va.gitbook.io/~gitbook/image?url=https%3A%2F%2F3225913148-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-M1LVsv044FMDdyLjX-C%252Fuploads%252Fgit-blob-8058fb9c0584cd92861f782de67062a618839f79%252Fgraphql-vs-rest.jpeg%3Falt%3Dmedia%26token%3Daced23b2-ad9d-48ce-b305-ed6778b2f0ea\&width=768\&dpr=4\&quality=100\&sign=a0e6d602\&sv=1)
...
* [Scalar](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#scalar-types)
* [Object](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#object-types), this includes the three special `root operation types`:
  * [Query](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#query-types)
  * [Mutation](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#mutation-types)
  * [Subscription](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#subscription-types)
* [Input](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#input-types)
* [Enum](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#enum-types)
* [Union](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#union-types)
* [Interface](https://0xn3va.gitbook.io/cheat-sheets/web-application/graphql-vulnerabilities#interface-types)
...
#### Introspection schema <a href="#introspection-schema" id="introspection-schema"></a>
...
You can also use various GraphQL IDEs or [GraphQL Voyager](https://github.com/graphql-kit/graphql-voyager) for introspection.

However, developers can forbid introspection of their applications. In this case, you can try to obtain the schema with the [`clairvoyance`](https://github.com/nikitastupin/clairvoyance).
...
#### Abuse GraphQL as an API gateway <a href="#abuse-graphql-as-an-api-gateway" id="abuse-graphql-as-an-api-gateway"></a>
...
### Abuse GraphQL engine <a href="#abuse-graphql-engine" id="abuse-graphql-engine"></a>

GraphQL engines are used to implement GraphQL API. The engines can have vulnerabilities or be misconfigured.

In order to determine which engine is used you can use the [`graphw00f`](https://github.com/dolevf/graphw00f).
...
#### Bypass of CSRF protection <a href="#bypass-of-csrf-protection" id="bypass-of-csrf-protection"></a>
...
#### Bypass of rate limits <a href="#bypass-of-rate-limits" id="bypass-of-rate-limits"></a>
...
#### Excessive errors <a href="#excessive-errors" id="excessive-errors"></a>
...
#### GraphQL injection <a href="#graphql-injection" id="graphql-injection"></a>
