# How I Bypassed SAML Authentication and Accessed the Admin Panel
...
![SAML Diagram 1](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*A0XuIowU9ovCuRYaYObfsw.png)
...
![SAML Response Anatomy](https://miro.medium.com/v2/resize:fit:400/format:webp/0*B8UD5YnG6X2fdlFH.png)
...
2. **Response Attributes**:
    - **ID**: An identifier for the SAML response ( unique ) .
...
![SAML Diagram 2](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*MA_lWMcMh-KLBfGf.png)

![SAML Diagram 3](https://miro.medium.com/v2/resize:fit:1400/format:webp/0*iEBa-Dz8SdOJ2yE8.png)
...
![Login Endpoint](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*N5cC0C0yx5PIKBoxOFxMqA.png)
...
![Source Code Check](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*CylH7kTGdRxc8fM5skn1Uw.png)
...
![Inspecting Request](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*Y1HVsM2M6-uI3IkJEs60WA.png)
...
![Altered Data](https://miro.medium.com/v2/resize:fit:600/format:webp/1*aN0Avjoqwo0GstmcrVoJcA.jpeg)
...
![Admin Created](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*5k5FzvDvXMm7dYGk9f_ahA.png)
