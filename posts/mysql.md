...
#### Using mysql Client <a href="#using-mysql-client" id="using-mysql-client"></a>
...
#### Using mysqldump <a href="#using-mysqldump" id="using-mysqldump"></a>
...
#### Metasploit Modules <a href="#metasploit-modules" id="metasploit-modules"></a>
...
#### User Defined Functions (UDF) for RCE <a href="#user-defined-functions-udf-for-rce" id="user-defined-functions-udf-for-rce"></a>
...
#### Credential Harvesting from Files <a href="#credential-harvesting-from-files" id="credential-harvesting-from-files"></a>
...
#### Raptor UDF Exploit <a href="#raptor-udf-exploit" id="raptor-udf-exploit"></a>
...
### Common MySQL Commands <a href="#common-mysql-commands" id="common-mysql-commands"></a>
...
* [Port 3306](https://hackviser.com/tactics/tags/port-3306)
